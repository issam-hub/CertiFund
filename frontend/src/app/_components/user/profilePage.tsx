            ...
            <div className="flex-grow">
              ...
              <div className="flex flex-wrap gap-6">
                <div className="flex items-center gap-2">
                  <Heart className="h-5 w-5 text-lightAccentColor" />
                  <span>0 Projects Backed</span>
                </div>
                <div className="flex items-center gap-2">
                  <Bell className="h-5 w-5 text-lightAccentColor" />
                  <span>0 Projects Created</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <Tabs defaultValue="created" className="w-full">
          ...
          <TabsContent value="created" className="space-y-6 focus-visible:ring-0 focus-visible:ring-offset-0">
            <div className={`grid grid-cols-1 ${projects.length > 0 ? "md:grid-cols-2 lg:grid-cols-3 gap-6":""}`}>
